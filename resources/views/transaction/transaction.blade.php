                ...
                <div class="col-12 d-flex justify-content-between align-items-center transaction-header">
                  <div class="d-flex justify-content-start align-items-center">
                    ...
                    <div class="transaction-code ml-3">
                      ...
                      <p class="m-0 text-white">D{{ date('dmYHis') }}</p>
                      <input type="text" name="kode_transaksi" value="D{{ date('dmYHis') }}" hidden="">
                    </div>
                  </div>
              ...
              <table class="table-payment-2">
                ...
                <tr>
                  ...
                  <td class="text-right d-flex justify-content-end align-items-center pt-2">
                    <input type="number" class="form-control diskon-input mr-2" min="0" max="999999" name="diskon" value="0" hidden="">
                    <span>Rp. </span>
